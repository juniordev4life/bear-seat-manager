...
function renderSchedule() {
  setTimeout(() => {
    ...
    config = {
      ...
      licenseKey:
        '====BEGIN LICENSE KEY====\||U2FsdGVkX1+xVid2sHccv+Uoe082bdnWR3UYDUTBWJUaeYDDqS8V7Xoy3gL8DBgVP7MYKczkd/NAtXgEGM0hAH30MWjHwxFfSAyaSWulaI8=\\n====END LICENSE KEY====',
      plugins: [],
      list: {
        columns: {
          data: {
